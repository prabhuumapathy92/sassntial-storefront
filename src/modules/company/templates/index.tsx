...
const CompanyTemplate = () => {
  return (
    <div className="content-container pt-3 pb-10 small:pt-4 small:pb-12">
        ...
        <div className="grid large:grid-cols-[1.08fr_0.92fr]">
          <div className="px-6 py-7 small:px-10 small:py-10">
            ...
            <h1 className="mt-3 max-w-3xl text-3xl-semi text-ui-fg-base">
              Company pages for team story, hiring, and direct contact.
            </h1>
            <p className="mt-4 max-w-2xl text-base-regular text-ui-fg-subtle">
              Use these pages to understand how the team works, where new roles
              fit, and how to start the right conversation for your project.
            </p>
      ...
      <div className="mt-4 grid gap-4 large:grid-cols-3">
        {companyItems.map((item, index) => (
          <LocalizedClientLink
            key={item.slug}
            href={`/company/${item.slug}`}

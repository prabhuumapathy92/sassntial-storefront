...
import { resourceItems } from "@modules/resources/constants/resource-items"
        ...
        <div className="grid large:grid-cols-[1.08fr_0.92fr]">
          <div className="px-6 py-7 small:px-10 small:py-10">
            ...
            <h1 className="mt-3 max-w-3xl text-3xl-semi text-ui-fg-base">
              Resource formats built to support planning, rollout, and growth.
            </h1>
            <p className="mt-4 max-w-2xl text-base-regular text-ui-fg-subtle">
              Use these materials to brief stakeholders, guide delivery teams,
              and create a clearer path from training strategy to execution.
            </p>
